...
namespace Rockabilly.CoarseGrind.Examples.Simple
{
	public class MultiLogExample : Test
	{
		private enum LogSuffix { Java, Jive, Rhythm, Rhyme };

		public override string DetailedDescription
		{
			get
			{
				return "This is the detailed description for MultiLogExample.  Use this field to describe what the test does and what its pass criteria are.";
			}
		}
		...
		public override void PerformTest()
		{
			...
			foreach (LogSuffix thisSuffix in Enum.GetValues(typeof(LogSuffix)))
			{
				// Create a separate log for a small portion of the test.
				Guid newLogReference = Log.AddHeadlinedOutput(IdentifiedName + " - " + thisSuffix, new TextOutputManager(ArtifactsDirectory + Path.DirectorySeparatorChar + thisSuffix + ".html"));
				...
				Log.ClearSpecificOutput(newLogReference);
			}
